...
const app = new Vue({
    ...
    methods: {
        ...
        async fetchWhishlist() {
            ...
            await this.fillDb('Yumpala', 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTGyOYesSO8zghrPr_KQVW5oQLMgVqyzJxA0PU-uax3Yen6IzP686MZRQQFpeO7HJ4IqtfSwdU2ZfeK/pub?gid=0&single=true&output=csv');
            ...
            await this.fillDb('souc', 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTrOCuSvtLnoBk8Ck-NrIyVRCFGe1CHNbXpW3imJnJNzYryuIEB_Ydyp0OG12gUA8hBYNQ7zo54d7oT/pub?gid=0&single=true&output=csv');
        },
